...
<body class="wrapper">
    ...
    <main>
        ...
        <a href="<%=request.getContextPath()%>/addBook" class="btn_add_book">書籍の追加</a> <a href="<%=request.getContextPath()%>/bulkRegist" class="btn_bulk_book">一括登録</a> <a href="<%=request.getContextPath()%>/lending" class="btn_lendbookrecord" >貸出履歴一覧</a> 
